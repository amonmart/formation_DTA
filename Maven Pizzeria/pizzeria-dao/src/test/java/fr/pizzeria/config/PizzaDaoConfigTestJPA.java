...
public class PizzaDaoConfigTestJPA {
	...
	public IFactoryDao factoryDao(){
		IFactoryDao factoryDao = new FactoryDaoJDBCTemplate(); 
		return factoryDao;
	}
	
	@Bean
	public IFactoryDao factoryDaoMemoire(){
		IFactoryDao factoryDao = new FactoryDaoMemoire(); 
		return factoryDao;
	}
	
	@Bean
	public IFactoryDao factoryDaoJPASpring(){
		IFactoryDao factoryDao = new FactoryDaoJPASpring(); 
		return factoryDao;
	}
